...
Usage:
    python run_coach_feedback.py                                          # Interactive
    python run_coach_feedback.py --file feedback_batch.json               # File mode
    python run_coach_feedback.py --term "张陈" "Trương Trần"              # Quick term
    python run_coach_feedback.py --term "张陈" "Trương Trần" --lock       # Quick locked entity
"""
