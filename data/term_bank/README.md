...
Private records take priority over global records. Use `universe`, `work`,
`franchise`, and `notes` for names or terms tied to a specific novel, film,
game, or shared-world canon.
