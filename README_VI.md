...
- `src/pipeline/`: import tài liệu với recovery cho directory batch, tách chapter, preserve structure, scan entity, build relationship, sinh `translation_config.json`.
