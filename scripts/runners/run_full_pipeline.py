...
Usage:
    python scripts/runners/run_full_pipeline.py                                  # Dịch chapter-001
    python scripts/runners/run_full_pipeline.py --chapter chapter-002             # Dịch chapter cụ thể
    python scripts/runners/run_full_pipeline.py --batch chapter-001 chapter-005   # Dịch hàng loạt
    python scripts/runners/run_full_pipeline.py --all                             # Dịch tất cả chapter
"""
...
def main():
    ...
    if not config_path.exists():
        ...
        print('   Run pretranslation first: python scripts/runners/run_pretranslation.py')
        return
    ...
    if total_issues > 0:
        ...
        print(f'         python scripts/runners/run_coach_feedback.py')
        print(f'         Sau đó dịch lại: python scripts/runners/run_full_pipeline.py --skip-pretranslation')
